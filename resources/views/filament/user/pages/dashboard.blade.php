        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <div class="mt-4 flex space-x-6 text-sm">
                <span class="text-gray-600 dark:text-gray-400">
                    {{ __('Completed') }}: <span class="font-semibold text-green-600">{{ $taskStats['completed'] }}</span>
                </span>
                <span class="text-gray-600 dark:text-gray-400">
        ...
        @if (count($tasks) > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($tasks as $task)
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200 flex flex-col">
                        <div class="p-6 flex-grow">
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <span @class([
                                    ...
                                    'bg-amber-100 text-amber-800 dark:bg-amber-900 dark:text-amber-200' => $task->status === 'pending',
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700">
